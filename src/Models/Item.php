...
class Item implements EbayModelInterface
{
     ...
     */
    public ?AuthenticityGuaranteeProgram $authenticityGuarantee;

    /**
     * A container for information about whether an item is from a verified seller.</span>
     * @var AuthenticityVerificationProgram|null
     */
    public ?AuthenticityVerificationProgram $authenticityVerification;
     ...
     */
    public ?ConvertedAmount $currentBidPrice;
     ...
     * @var ConvertedAmount|null
     */
    public ?ConvertedAmount $ecoParticipationFee;
     ...
     */
    public ?HazardousMaterialsLabels $hazardousMaterialsLabels;
     ...
     * @var ConvertedAmount|null
     */
    public ?ConvertedAmount $minimumPriceToBid;
     ...
     */
    public ?PriceDisplayConditionEnum $priceDisplayCondition;
     ...
     */
    public ?ItemGroupSummary $primaryItemGroup;
     ...
     */
    public ?ReviewRating $primaryProductReviewRating;
     ...
     */
    public ?ItemReturnTerms $returnTerms;
     ...
     * @var ConvertedAmount|null
     */
    public ?ConvertedAmount $unitPrice;
